...
const COURSES_URL = "https://kanbas-node-server-app-a6-iz9r.onrender.com/api/courses";
const ASSIGNMENTS_URL = "https://kanbas-node-server-app-a6-iz9r.onrender.com/api/assignments";
